...
import { Search, ChevronDown, Star, X, ChevronLeft, ChevronRight, Eye, Ear, Keyboard, Brain, History, Mic, VolumeX } from 'lucide-react';
...
const SearchTech = () => {
  ...
  useEffect(() => {
    ...
    fetchSearchResults();
  }, [searchQuery, technologies, voices, isMuted]);
